...
| Path | What it is |
| --- | --- |
| [`portfolio/Xin-Weicheng-Portfolio.pdf`](./portfolio/Xin-Weicheng-Portfolio.pdf) | 18-page portfolio: four case studies with product screenshots, numbers and design trade-offs |
...
- 535 / 671 contracts matched through technical fingerprinting (MD5, file size, text content)
